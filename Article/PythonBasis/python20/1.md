...
e = Employee('水哥', '做鸭事业部', 1001, '2020-03-15', 12000)
print(e)
```
...
```
Employee(name='水哥', dept='做鸭事业部', emp_id=1001, hire_date='2020-03-15', salary=12000)
```
...
a = Employee('水哥', '做鸭事业部', 12000)
b = Employee('水哥', '做鸭事业部', 12000)
c = Employee('水哥', '做鸭事业部', 15000)
...
```
Employee(name='水哥', dept='做鸭事业部', salary=8000)
...
cache[key] = {'name': '水哥', 'avatar': 'xxx.png'}
...
# 老代码 Employee('水哥', '做鸭事业部', 12000) 还会运行，但语义完全错了
```
...
e = Employee(name='水哥', dept='做鸭事业部', salary=12000)
print(e)

# 想偷懒按位置传？直接报错
try:
    bad = Employee('水哥', '做鸭事业部', 12000)
...
```
Employee(name='水哥', dept='做鸭事业部', salary=12000)
...
u: UserProfile = {'name': '水哥', 'age': 28, 'email': 'liangdianshui@xxx.com'}
print(u)
print(u['name'])
```
...
```
{'name': '水哥', 'age': 28, 'email': 'liangdianshui@xxx.com'}
水哥
```
...
e = Employee(name='水哥', age=28, salary=12000.0)
print(e)
```
...
e = Employee(name='水哥', age='28', salary='12000.5')
print(e)
...
try:
    e = Employee(name='水哥', age='abc', salary='not a number')
...
# 从一段 JSON 字符串解析
json_str = '{"name": "水哥", "age": 28, "salary": 12000}'
...
```
name='水哥' age=28 salary=12000.0 rating=60
...
e = Employee.model_validate({'name': '水哥', 'empId': 1001})
print(e)
print(e.employee_id)
```
...
u = User(name='水哥', email='liangdianshui@example.com', homepage='https://example.com')
print(u)
...
```
name='水哥' email='liangdianshui@example.com' homepage=Url('https://example.com/')
