...
print_user_info( name = '水哥' ,age = 18 , sex = '女')
print_user_info( name = '水哥' ,sex = '女', age = 18 )
...
# 调用 print_user_info 函数
print_user_info( '水哥' ,18 , '女', '打篮球','打羽毛球','跑步')
...
```python
昵称：水哥 年龄：18 性别：女 爱好：('打篮球', '打羽毛球', '跑步')
```
...
# 调用 print_user_info 函数
print_user_info( name = '水哥' , age = 18 , sex = '女', hobby = ('打篮球','打羽毛球','跑步'))
...
```txt
昵称：水哥 年龄：18 性别：女 爱好：{'hobby': ('打篮球', '打羽毛球', '跑步')}	
```
...
#print_user_info( '水哥' , 18 , '女' )
print_user_info('水哥',age='22',sex='男')
```
...
book: PhoneBook = {'水哥': '131456780002'}
print(find_phone(book, '水哥'))
```
