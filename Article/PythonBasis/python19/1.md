...
来，咱们用一个「打卡」业务场景说明。「两点水」在「做鸭事业部」搞了个打卡系统，业务规则有：
...
先抛痛点。假设「两点水」在「做鸭事业部」搞了个批量任务：要给五个 URL 发请求，把结果都存下来。代码大概长这样：
...
来个例子。假设「两点水」要批量更新员工信息，每个员工有「基础信息」和「打卡记录」两部分要分别更新，每一部分都可能失败：
