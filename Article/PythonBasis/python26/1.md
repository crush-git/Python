...
```
2026-04-28 09:00:00 - INFO - 水哥准备打卡
...
```
2026-04-28 09:00:00 - __main__ - INFO - 用户 水哥 开始打卡
```
...
```
2026-04-28 09:00:00 - app.services.punch - INFO - 水哥打卡了
...
logger.info("水哥打卡", extra={"user": "水哥", "method": "fingerprint"})
```

输出：

```json
{"asctime": "2026-04-28 09:00:00", "name": "app", "levelname": "INFO", "message": "水哥打卡", "user": "水哥", "method": "fingerprint"}
```
...
logger.info("水哥打卡", user="水哥", method="fingerprint")
```

`structlog` 默认输出长这样——开发期间彩色、清爽：

```
2026-04-28 09:00:00 [info     ] 水哥打卡 method=fingerprint user=水哥
```
...
```json
{"event": "水哥打卡", "user": "水哥", "method": "fingerprint", "level": "info", "timestamp": "2026-04-28T09:00:00"}
```
...
2026-04-28 09:00:00 - attend.services.punch - INFO - 用户 水哥 开始打卡
2026-04-28 09:00:00 - attend.services.punch - INFO - 用户 水哥 打卡成功
