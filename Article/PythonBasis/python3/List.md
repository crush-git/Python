...
```python
list1=['水哥','twowter','liangdianshui',123]
```
...
user=['liangdianshui','twowater','水哥']
print('1.产品用户')
print(user)
...
4.在末尾添加新用户
['liangdianshui', 'twowater', '水哥', '茵茵']

5.指定位置添加用户
['VIP用户', 'liangdianshui', 'twowater', '水哥', '茵茵']

6.删除末尾用户
['VIP用户', 'liangdianshui', 'twowater', '水哥']
