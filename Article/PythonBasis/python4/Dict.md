...
```python
name = [['一点水', '131456780001'], ['水哥', '131456780002'], ['三点水', '131456780003'], ['四点水', '131456780004'], ['五点水', '131456780005']]
```
...
```python
dict1={'liangdianshui':'111111' ,'twowater':'222222' ,'水哥':'333333'}
...
```
{'liangdianshui': '111111', 'twowater': '222222', '水哥': '333333'}
{'liangdianshui': '111111', 'twowater': '222222', '水哥': '333333', 'jack': '444444'}
{'liangdianshui': '555555', 'twowater': '222222', '水哥': '333333', 'jack': '444444'}
```
...
```
{'liangdianshui': '111111', 'twowater': '222222', '水哥': '333333'}
{'liangdianshui': '111111', '水哥': '333333'}
{}
```
...
```python
#-*-coding:utf-8-*-
dict1={'liangdianshui':'111111' ,'twowater':'222222' ,'水哥':'333333','twowater':'444444'}
print(dict1)
...
```
{'liangdianshui': '111111', 'twowater': '444444', '水哥': '333333'}
444444
```
...
```python
old_contacts = {'一点水': '131456780001', '水哥': '131456780002'}
new_contacts = {'三点水': '131456780003', '水哥': '131456780099'}
```
...
```
{'一点水': '131456780001', '水哥': '131456780099', '三点水': '131456780003'}
```
